...
angular.module('starter', ['ionic', 'starter.services', 'starter.vocabulary', 'starter.controllers', 'starter.directives'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    // the exercise tab has its own child nav-view and history
